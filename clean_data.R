...
player_season_data_per_game = player_season_data_per_game[,c('seas_id',
                                                             'season',
                                                             'player_id',
                                                             'player',
                                                             'x2p_percent',
...
player_season_data_per_game = gather(player_season_data_per_game, key = 'distance', value = "sht_percentage",
                                     x2p_percent,
                                     x3p_percent,
                                     ft_percent) 
...
player_season_data_per_game$player_all_info_text <- paste0(player_season_data_per_game$player_add_team_year_name, 
